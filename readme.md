...
сам сайт: [сайт](https://bendygo.github.io/TEST/main.html)

https://bendygo.github.io/TEST/main.html
...
│       │   ├── tasks_rus.db       # Задания по русскому языку
│       │   ├── tasks_math.db      # Задания по математике
│       │   └── tasksDatabase.go   # Логика работы с БД заданий
│       └── usersDatabase/         # БД пользователей
│           ├── users.db           # База пользователей
│           └── usersDatabase.go   # Логика работы с БД пользователей
└── Front/                         # Клиентская часть
    ...
    │   ├── tasks.js               # Загрузка и фильтрация заданий
    │   ├── pvp.js                 # WebSocket-логика PvP-матчей
    │   └── admin.js               # Логика панели администратора
    └── css/                       # Стили
        ├── style.css              # Общие стили
        ├── login.css              # Стили страницы входа
        ├── register.css           # Стили страницы регистрации
        ├── tasks.css              # Стили каталога заданий
        ├── pvp.css                # Стили PvP-режима
